...
export const SearchBar = ({ onFocusChange, isFocused }: SearchBarProps) => {
  ...
  return (
    <div className="flex justify-between items-center gap-[30px] px-2 py-2 rounded-lg bg-gray-90 border border-gray-80 w-[536px] h-10">
          ...
          <ul className="flex flex-col">
            {MOCK_RESULTS.map((item) => (
              ...
              >
                ...
                <span className="text-gray-30 ml-2">({item.category})</span>
              </li>
            ))}
          </ul>

          <div className="p-[10px] w-full">
            <button className="w-full h-[42px] border border-primary-20 py-3 bg-secondary-dark text-primary-0 rounded-[32px] font-semibold text-sm hover:bg-gray-100 transition-all">
