...
export const WhatShouldIWatch = () => {
  ...
  return (
    <div className="mx-12 mt-11 bg-secondary-bg px-8 py-11 rounded-[51px] overflow-hidden
    ...
    ">
      <div className="flex flex-col md:flex-row justify-start md:justify-between items-start md:items-center">
        <div className="flex gap-2 items-center">
          ...
          <h2 className="text-[24px] md:text-[36px] text-primary-0-text [text-shadow:_0_0_1px_currentColor] [-webkit-text-stroke:_0.8px_currentColor] leading-[1.2] font-black font-nunito">What should I watch?</h2>
        </div>
        <div className="">
          <button
          ...
          >
            ...
            <div className="text-primary-0-text cursor-pointer">
      ...
      <div className="flex justify-center items-center">
        <button
          ...
          className="cursor-pointer border-none rounded-[32px] bg-primary-0-text w-[522px] h-10 md:h-[56px] flex justify-center items-center relative z-10"
        >
